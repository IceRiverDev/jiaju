            ...
            $("#code").blur(function () {
                ...
                $.getJSON("memberServlet", {
                    ...
                    if (!data.isCodeCorrect) {
                        $("span[class='errorMsg']").text("验证码不正确");
                    } else {
                            ...
                            <div class="login-form-container">
                                <div class="login-register-form">
                                    ...
                                    <form action="memberServlet" method="post">
                                        ...
                                        <input name="email" id="email"  value="${email}" placeholder="电子邮件" type="email"/>
                                        <input type="text" id="code" name="code" style="width: 50%"
                                               placeholder="验证码"/>　　<img id="codeImage" alt="" src="kaptchaServlet">
                                        <div class="button-box">
