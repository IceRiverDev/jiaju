    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <form action="furnitureServlet?action=update&pageNo=${param.pageNo}&id=${requestScope.furn.id}" method="post" enctype="multipart/form-data">
                    <%--传id--%>
                        ...
                        <table>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <img class="img-responsive ml-3" src="${requestScope.furn.imagePath}" alt="" id="prevView"/>
                                    <input type="file" name="imageFile" value="${requestScope.furn.imagePath}" onchange="prev(this)"/>
                                </td>
                                ...
                                <td>
                                    ...
                                    <input id="updatefurn" type="submit"
