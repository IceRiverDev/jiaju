            ...
            $("button.add-to-cart").click(function () {
                ...
                $.getJSON("cartServlet", {
                    ...
                    if (data.url == undefined) { //没有返回url ,表示已经登录过.
                        ...
                        $("span.header-action-num").text(data.cartItemsTotalCount);
                    } else {
                        //说明当前服务器返回url ,要求你定位
                    ...
                    <div class="header-actions">
                        ...
                        <a href="views/cart/cart.jsp"
                           class="header-action-btn header-action-btn-cart pr-0">
                            ...
                            <span id="cart" class="header-action-num">${sessionScope.cart.totalCount}</span>
                        </a>
...
<!-- OffCanvas CartItem Start 弹出cart -->
<!-- OffCanvas CartItem End -->
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                ...
                                                <img class="hover-image" src="${furn.imagePath}"
                                                     alt="Product"/>
                                            </a>
                                            <span class="badges">
                                            ...
                                            <c:if test="${furn.stock <= 0}">
                                                <button title="售罄" furnId="${furn.id}"
                                                        furnStock=${furn.stock} class="add-to-cart">
                                                    售罄
                                                </button>
                                            </c:if>
                                            <c:if test="${furn.stock > 0}">
                                                <button title="加入购物车" furnId="${furn.id}"
                                                        furnStock=${furn.stock} class="add-to-cart">
                                                    加入购物车
                                                </button>
                                            </c:if>
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        ...
        <c:forEach begin="${begin}" end="${end}" var="i">
            <c:choose>
                <c:when test="${i == requestScope.page.pageNo}">
                    <li><a class="active"
                           href="${requestScope.page.url}&pageNo=${i}">${i}</a></li>
                </c:when>
                <c:otherwise>
        ...
        <li><a href="${requestScope.page.url}&pageNo=${requestScope.page.pageTotalCount}">最后一页</a></li>
